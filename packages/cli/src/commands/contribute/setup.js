...
async function setup() {
  console.log(chalk`
{bold Hi there!} 👋
This tools is built for people looking to contribute to the Chance the Developer Design System!`);
...
`);
  ...
  console.log('Done! 🥳  Thanks so much for contributing! 🙏');
}
...
an issue over at:
{link https://github.com/chancestrickland/chancethedev-design/issues/new/choose}`
      );
    }
  };
}
...
const availableProjects = [
  {
    ...
    value: {
      owner: 'chancestrickland',
      repo: 'chancethedev-design',
  ...
  /* {
    name: '@chancethedev/design-website',
    value: {
      owner: 'chancestrickland',
      repo: 'chancethedev-design-website',
      gitCloneEstimate: 180 * 1000,
      commands: [
        {
          command: 'yarn install --offline',
  ...
  {
    name: 'gatsby-theme-chancethedev',
    value: {
      owner: 'chancestickland',
      repo: 'gatsby-theme-chancethedev',
